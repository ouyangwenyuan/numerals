...
public class CommonUtil
{
		...
		public static int LevelStarsNumberEnumToIntNumber (TableLevel.StarsNumber starsNumber)
		{
				if (starsNumber == TableLevel.StarsNumber.ZERO) {
						return 0;
				} else if (starsNumber == TableLevel.StarsNumber.ONE) {
						return 1;
		...
		public static TableLevel.StarsNumber IntNumberToLevelStarsNumberEnum (int starsNumber)
		{
				if (starsNumber == 1) {
						...
						return TableLevel.StarsNumber.ZERO;
				}
		}
