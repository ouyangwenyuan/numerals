...
{	
		...
		/// <summary>
		/// The group size ratio.
		/// </summary>
		[Range(0.1f,5.0f)]
		public float groupSizeRatio = 1;
		...
		private void CalculateGridLayoutsValues ()
		{
					...
					groupsGridLayout.cellSize = new Vector2 (rectTransform.rect.width * groupSizeRatio, rectTransform.rect.height * groupSizeRatio);
		}
